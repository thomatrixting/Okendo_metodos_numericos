...
long double integrate_vectorial_function_gauss5(vector<std::function<fptr>>& vectorial_function, const vector<vector<long double>> integration_limits);
...
int main(int argc, char **argv){
    ...
    //int (*p[4]) (int, int)
    vector<std::function<fptr>> F_vectorial = {force_x_function, force_y_function};
